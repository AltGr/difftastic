...
fn main() {
    let parsers = vec![
        ...
        TreeSitterParser {
            name: "tree-sitter-catala_en",
            src_dir: "vendored_parsers/tree-sitter-catala_en-src",
            extra_files: vec![],
        },
        TreeSitterParser {
            name: "tree-sitter-catala_fr",
            src_dir: "vendored_parsers/tree-sitter-catala_fr-src",
            extra_files: vec![],
        },
    ];
